...
from modules.logscan_resume import (
    ...
    resolve_config_path_for_command as _resolve_config_path_for_command,
    inject_config_path_for_command as _inject_config_path_for_command,
    iso_from_mtime as _iso_from_mtime,
    extract_first_log_timestamp as _extract_first_log_timestamp,
    extract_last_log_timestamp as _extract_last_log_timestamp,
    format_duration_brief as _format_duration_brief,
    build_incomplete_run_timing_summary as _build_incomplete_run_timing_summary,
    build_incomplete_scope_summary as _build_incomplete_scope_summary,
    build_maintenance_event_rows as _build_maintenance_event_rows,
    build_incomplete_resume_message as _build_incomplete_resume_message,
    build_completed_scope_resume_message as _build_completed_scope_resume_message,
    build_recovery_suggestions as _build_recovery_suggestions,
    extract_cli_option_value as _extract_cli_option_value,
    detect_explicit_phase_from_command as _detect_explicit_phase_from_command,
    build_resume_explanation as _build_resume_explanation,
)
